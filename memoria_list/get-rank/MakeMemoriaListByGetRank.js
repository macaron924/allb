let ranks = [
    ...
    },
    {
        "rank": "イベント「ユリの花咲く場所」",
        "index": "yuri-event",
        "summary": "→ 季節メモリアじゃないのでシーズンガチャには入らないが限定扱い。2.5周年無料ガチャでは剥奪されなかったが、季節メモリアよりも入手方法がかなり限られている。衣装は160円パックで交換可。",
        "content": []
    },
    {
        "rank": "季節",
        "index": "season",
        "summary": "→ 入手方法がかなり限られていたが、不定期にシーズンガチャとして復刻するようになった(110連で交換も可)。GWのアイドルもなぜかシーズン。古いものから順に確率アップの対象外になる(交換は可)。",
        "content": []
    },
    {
        "rank": "季節 (推定)",
        "index": "season_est",
        "summary": "→ ホリデイガチャの今後の扱いは不明だが、季節扱いになると予想。",
        "content": []
    },
    {
        "rank": "レジェンダリーを含むイベント (推定)",
        "index": "event_est",
        "summary": "→ 季節でもメイン3章でもないイベントだけど復刻が少ない。レジェンダリーがあるのが理由と考えられる。",
        "content": []
    },
    {
        "rank": "レジェンダリーのない限定イベント (推定)",
        "index": "event_est",
    ...
    },
    {
        "rank": "メインストーリー3章",
        "index": "main-story-3",
        "summary": "→ 現時点では限定並扱い。しかし一部(グラン・エプレ前編)は新規イベント以外の様々なガチャから出てた時期もあったので今後その形になる可能性も。グラン・エプレは2.5周年で、クエレブレはクリスマス記念で一斉復刻済み。",
        "content": []
    },
    {
        "rank": "メインストーリー3章 (未復刻)",
