skillJson = [
    ...
    {
        "name": "チャージストライクB Ⅱ",
        "effect_detail": "敵1～2体に通常ダメージを与える。バトル時間30秒経過ごとにスキル効果がアップし、120秒経過で最大になる。",
        "yakuwari": 2,
        "tag": [
            ["通常ダメージ", "中"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージヒールC Ⅱ",
        "effect_detail": "味方1～3体のHPを小回復する。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 7,
        "tag": [
            ["味方回復", "小"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージパワーアシストB Ⅱ",
        "effect_detail": "味方1～2体のATKをアップさせる。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 5,
        "tag": [
            ["ATK↑", "中"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージストライクA Ⅲ",
        "effect_detail": "敵1体に通常大ダメージを与える。バトル時間30秒経過ごとにスキル効果がアップし、120秒経過で最大になる。",
        "yakuwari": 1,
        "tag": [
            ["通常ダメージ", "大"],
            ["チャージ", "中"]
    ...
    },
    {
        ...
        "effect_detail": "敵1～2体のSp.ATKをダウンさせる。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 6,
        "tag": [
            ["Sp.ATK↓", "中"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージスマッシュA Ⅲ",
        "effect_detail": "敵1体に特殊大ダメージを与える。バトル時間30秒経過ごとにスキル効果がアップし、120秒経過で最大になる。",
        "yakuwari": 3,
        "tag": [
            ["特殊ダメージ", "大"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージスマッシュB Ⅱ",
        "effect_detail": "敵1～2体に特殊ダメージを与える。バトル時間30秒経過ごとにスキル効果がアップし、120秒経過で最大になる。",
        "yakuwari": 4,
        "tag": [
            ["特殊ダメージ", "中"],
            ["チャージ", "中"]
    ...
    },
    {
        ...
        "effect_detail": "味方1～2体のSp.ATKをアップさせる。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 5,
        "tag": [
            ["Sp.ATK↑", "中"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージヒールD Ⅱ",
        "effect_detail": "味方2体のHPを小回復する。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 7,
        "tag": [
            ["味方回復", "小"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージガードアシストC Ⅲ",
        "effect_detail": "味方1～3体のDEFをアップさせる。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 5,
        "tag": [
            ["DEF↑", "中"],
            ["チャージ", "中"]
    ...
    },
    {
        ...
        "effect_detail": "味方1～3体のSp.DEFをアップさせる。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 5,
        "tag": [
            ["Sp.DEF↑", "中"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージパワーフォールB Ⅱ",
        "effect_detail": "敵1～2体のATKをダウンさせる。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 6,
        "tag": [
            ["ATK↓", "中"],
            ["チャージ", "中"]
    ...
    {
        "name": "チャージガードフォールB Ⅱ",
        "effect_detail": "敵1～2体のDEFをダウンさせる。バトル時間60秒経過ごとにスキル効果がアップし、600秒経過で最大になる。",
        "yakuwari": 6,
        "tag": [
            ["DEF↓", "中"],
            ["チャージ", "中"]
