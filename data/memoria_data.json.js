const memoriaJson = [
    ...
    },
    {
        ...
        get_rank: "C", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2023/10/3～)", c3: [""] },
        skill: [
    ...
    },
    {
        ...
        get_rank: "C", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2023/10/16～)", c3: [""] },
        skill: [
            { yakuwari: 2, name: ["マイトストライクB Ⅲ+", "カウンターパワーストライクB Ⅲ", "攻:ダメージUP/パワーUP Ⅲ"] },
    ...
    },
    {
        ...
        get_rank: "レジェンダリーのない限定イベント (推定)", category: { c1: "メダル/ギガント級討伐イベント", c2: "ゴシック・ノスタルジカ ―失われた刻を探して― / ギガント級ヒュージ討伐 (2023/10/22～)", c3: ["イベントガチャ"] },
        skill: [
            { yakuwari: 4, name: ["Sp.マイトスマッシュB Ⅲ+", "Sp.ファイアパワースマッシュB Ⅲ+", "攻:Sp.パワーUP Ⅲ"] },
    ...
    },
    {
        ...
        get_rank: "C", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2023/10/26～)", c3: [""] },
        skill: [
    ...
    },
    {
        ...
        get_rank: "C", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2023/11/5～)", c3: [""] },
        skill: [
    ...
    },
    {
        ...
        get_rank: "C", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "オータムフェス前衛後衛ガチャ (2023/11/8～)", c3: ["前衛ガチャ"] },
        skill: [
            { yakuwari: 2, name: ["マイトストライクB Ⅲ+", "ウォーターパワーストライクB Ⅲ+", "攻:ダメージUP/パワーUP Ⅲ"] },
    ...
    },
    {
        ...
        get_rank: "C", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "オータムフェス前衛後衛ガチャ (2023/11/8～)", c3: ["後衛ガチャ"] },
        skill: [
    ...
    },
    {
        ...
        get_rank: "C", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2023/11/13～)", c3: [""] },
        skill: [
    ...
    },
    {
        ...
        get_rank: "レジェンダリーのない限定イベント (推定)", category: { c1: "メダル/ギガント級討伐イベント", c2: "ゴシック・ノスタルジカ ―幻想織りなす黄金律― / ギガント級ヒュージ討伐 (2023/11/22～)", c3: ["イベントガチャ"] },
        skill: [
    ...
    },
    {
        ...
        get_rank: "C", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2023/11/23～)", c3: [""] },
        skill: [
    ...
    },
    {
        ...
        get_rank: "レジェンダリーのない限定イベント (推定)", category: { c1: "メダル/ギガント級討伐イベント", c2: "ゴシック・ノスタルジカ ―可惜夜に響く鐘― / ギガント級ヒュージ討伐 (2024/1/6～)", c3: ["イベントガチャ"] },
        skill: [
    ...
    },
    {
        id: 785,
        name: "婀娜やかな誘い",
        zokusei: 1, cost: 24, costume: 517, legendary: "ガチャ", illustration: { type: "", chara: [8] },
        get_rank: "3周年", category: { c1: "メダル/ギガント級討伐イベント", c2: "Dreamin'☆Celebration (2024/1/20～)", c3: ["3rd Anniv. DREAM Party - YUJIA & AKARI / HIMEKA -ガチャ (2024/1/23～) (特効はバトルパーティのみ)"] },
        skill: [
    ...
    },
    {
        id: 786,
        name: "月灯りに姫と歌う",
        zokusei: 1, cost: 22, costume: 518, legendary: "", illustration: { type: "", chara: [18, 19] },
        get_rank: "3周年", category: { c1: "メダル/ギガント級討伐イベント", c2: "Dreamin'☆Celebration (2024/1/20～)", c3: ["3rd Anniv. DREAM Party - YUJIA & AKARI / HIMEKA -ガチャ (2024/1/23～) (特効はバトルパーティのみ)"] },
        skill: [
            { yakuwari: 5, name: ["Sp.マイトアシストE Ⅳ", "Sp.ファイアパワーアシストE Ⅳ", "援:支援UP/Sp.パワーUP Ⅳ"] },
    ...
    {
        id: 801,
        name: "クリエイターズコラボ-せんぱいのお花たち-",
        zokusei: 3, cost: 22, costume: 569, legendary: "", illustration: { type: "クリエイターズコラボ", chara: [18, 15] },
        get_rank: "C (推定)", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2024/2/9～)", c3: [""] },
        skill: [
            { yakuwari: 4, name: ["Sp.マイトスマッシュB Ⅳ+", "風拡：Sp.ウィンドパワースマッシュB Ⅳ+", "攻:ダメージUP/副攻:風パワーUP Ⅳ"] },
            { yakuwari: 5, name: ["WパワーアシストE Ⅳ", "WカウンターパワーアシストE Ⅳ", "援:WパワーUP Ⅳ"] },
            { yakuwari: 7, name: ["ガードヒールC Ⅴ", "カウンターウィンドガードヒールC Ⅴ", "回:ガードUP/副援:風ガードUP Ⅳ"] }
        ]
    },
    {
        id: 802,
        name: "クリエイターズコラボ-可憐な香に包まれて-",
        zokusei: 2, cost: 22, costume: 0, legendary: "", illustration: { type: "クリエイターズコラボ", chara: [56, 1] },
        get_rank: "C (推定)", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2024/2/9～)", c3: [""] },
        skill: [
            { yakuwari: 7, name: ["Sp.ガードヒールE Ⅳ", "Sp.ウォーターガードヒールE Ⅳ", "回:回復UP/副援:支援UP Ⅳ"] },
            { yakuwari: 2, name: ["マイトブレイクD Ⅲ+", "ウォーターガードブレイクD Ⅲ+", "攻:ダメージUP/ガードDOWN Ⅳ"] },
            { yakuwari: 4, name: ["Sp.マイトスマッシュB Ⅳ+", "Sp.ウォーターパワースマッシュB Ⅳ+", "攻:ダメージUP/Sp.パワーUP Ⅳ"] },
    ...
    {
        id: 806,
        name: "クリエイターズコラボ-あなたのカメリア-",
        zokusei: 1, cost: 22, costume: 581, legendary: "", illustration: { type: "クリエイターズコラボ", chara: [14, 10] },
        get_rank: "C (推定)", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2024/2/13～)", c3: [""] },
        skill: [
            { yakuwari: 4, name: ["Sp.マイトスマッシュB Ⅳ+", "Sp.ファイアパワースマッシュB Ⅳ+", "攻:ダメージUP/Sp.パワーUP Ⅳ"] },
            { yakuwari: 5, name: ["パワーアシストE Ⅳ", "ファイアパワーアシストE Ⅳ", "援:支援UP/副援:火パワーUP Ⅳ"] },
            { yakuwari: 6, name: ["Sp.パワーフォールE Ⅳ", "Sp.ファイアパワーフォールE Ⅳ", "援:支援UP/副援:火パワーDOWN Ⅳ"] }
        ]
    },
    {
        id: 807,
        name: "クリエイターズコラボ-小さな幸せを冠して-",
        zokusei: 3, cost: 22, costume: 0, legendary: "", illustration: { type: "クリエイターズコラボ", chara: [103, 71] },
        get_rank: "C (推定)", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2024/2/13～)", c3: [""] },
        skill: [
            { yakuwari: 6, name: ["WパワーフォールE Ⅳ", "WカウンターパワーフォールE Ⅳ", "援:WパワーDOWN Ⅳ"] },
            { yakuwari: 2, name: ["マイトストライクD Ⅲ+", "風：ウィンドパワーストライクD Ⅲ+", "攻:ダメージUP/副攻:風パワーUP Ⅳ"] },
    ...
    {
        id: 828,
        name: "クリエイターズコラボ-くまさんといっしょ-",
        zokusei: 1, cost: 22, costume: 603, legendary: "", illustration: { type: "クリエイターズコラボ", chara: [13, 11] },
        get_rank: "C (推定)", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2024/3/13～)", c3: [""] },
        skill: [
            { yakuwari: 4, name: ["Sp.マイトスマッシュD Ⅲ+", "Sp.ファイアパワースマッシュD Ⅲ+", "攻:ダメージUP/Sp.パワーUP Ⅳ"] },
            { yakuwari: 3, name: ["Sp.マイトスマッシュA Ⅴ+", "Sp.ファイアパワースマッシュA Ⅴ+", "攻:ダメージUP/副攻:火パワーUP Ⅳ"] },
            { yakuwari: 5, name: ["パワーアシストE Ⅳ", "ファイアパワーアシストE Ⅳ", "援:支援UP/パワーUP Ⅳ"] },
            { yakuwari: 7, name: ["ガードヒールC Ⅴ", "ファイアガードヒールC Ⅴ", "回:回復UP/副援:火ガードUP Ⅳ"] }
        ]
    },
    {
        id: 829,
        name: "クリエイターズコラボ-お手軽ティータイム-",
        zokusei: 3, cost: 22, costume: 0, legendary: "", illustration: { type: "クリエイターズコラボ", chara: [99, 98] },
        get_rank: "C (推定)", category: { c1: "前衛後衛/役割別/クリエイターズコラボガチャ", c2: "BRAND-NEWメモリアガチャ (2024/3/13～)", c3: [""] },
        skill: [
            { yakuwari: 6, name: ["WパワーフォールE Ⅳ", "WカウンターパワーフォールE Ⅳ", "援:支援UP/副援:風パワーDOWN Ⅳ"] },
            { yakuwari: 2, name: ["マイトブレイクD Ⅲ+", "カウンターウィンドガードブレイクD Ⅲ+", "攻:ダメージUP/ガードDOWN Ⅳ"] },
    ...
    },
    {
        id: 837,
        name: "ジョーカーと狂犬",
        zokusei: 2, cost: 24, costume: 608, legendary: "ガチャ", illustration: { type: "", chara: [26, 119] },
        get_rank: "メインストーリー4章 (未復刻)", category: { c1: "メダル/ギガント級討伐イベント", c2: "溟海のブルーローズ (2024/3/31～)", c3: ["イベントガチャ"] },
        skill: [
            { yakuwari: 5, name: ["水：WパワーアシストE Ⅳ", "水：WパワーアシストE Ⅳ", "援:支援UP/副援:水パワーUP Ⅳ"] },
            { yakuwari: 2, name: ["水：ガードブレイクB Ⅳ", "水：ガードブレイクB Ⅳ", "攻:ダメージUP/ガードDOWN Ⅳ"] },
            { yakuwari: 7, name: ["Sp.ガードヒールC Ⅴ", "水：Sp.ウォーターガードヒールC Ⅴ", "回:回復UP/副援:支援UP Ⅳ"] }
        ]
    },
    {
        id: 838,
        name: "湖上の妖精舞踊",
        zokusei: 1, cost: 22, costume: 609, legendary: "", illustration: { type: "", chara: [119] },
        get_rank: "メインストーリー4章 (未復刻)", category: { c1: "メダル/ギガント級討伐イベント", c2: "溟海のブルーローズ (2024/3/31～)", c3: ["イベントガチャ"] },
        skill: [
            { yakuwari: 2, name: ["マイトストライクB Ⅳ+", "ファイアパワーストライクB Ⅳ+", "攻:パワーUP/副攻:火パワーUP Ⅳ"] },
            { yakuwari: 4, name: ["Sp.マイトバーストB Ⅳ+", "Sp.ファイアガードバーストB Ⅳ+", "攻:ダメージUP/副攻:火ガードDOWN Ⅳ"] },
            { yakuwari: 6, name: ["WパワーフォールE Ⅳ", "WパワーフォールE Ⅳ", "援:WパワーDOWN Ⅳ"] }
        ]
    },
    {
        id: 839,
        name: "大胆不敵な一番槍",
        zokusei: 2, cost: 22, costume: 611, legendary: "", illustration: { type: "", chara: [28] },
        get_rank: "メインストーリー4章 (未復刻)", category: { c1: "メダル/ギガント級討伐イベント", c2: "溟海のブルーローズ (2024/3/31～)", c3: ["イベントガチャ"] },
        skill: [
            { yakuwari: 4, name: ["Sp.マイトスマッシュB Ⅳ+", "Sp.ウォーターパワースマッシュB Ⅳ+", "攻:Sp.パワーUP/副攻:水パワーUP Ⅳ"] },
            { yakuwari: 2, name: ["マイトストライクB Ⅳ+", "ウォーターパワーストライクB Ⅳ+", "攻:パワーUP/副攻:水パワーUP Ⅳ"] },
